        ...
        <Router>
            ...
            <div className="App">
                ...
                <Routes>
                    <Route
                        path="/"
                        element={<Home handleAddComp={handleAddComparison} />}
                    />
                    ...
                    <Route
                        ...
                        element={
                            <ProductsComparison
                                handleDelComp={handleDelComparison}
                    ...
                    <Route
                        path="products"
                        element={
                            <ProductsPage handleAddComp={handleAddComparison} />
                        }
                    />
                    <Route
                        path="/products/:id"
                        element={
                            <Categories handleAddComp={handleAddComparison} />
                        }
                    />
                    <Route
                    ...
                    <Route
                        ...
                        element={
                            <BrandsProduct
                                handleAddComp={handleAddComparison}
                            />
                        }
                    />
                    <Route
                        path="brands/:id/detail/:id"
                        element={<ProductDetails />}
                    />
