...
import pic2 from "../../assets/images/AboutUs/2.jfif";
import video2 from "../../assets/images/AboutUs/videoAboutUs.mp4";
...
const AboutUs = () => {
    return (
        <div className="container-img">
            ...
            <section className="aboutus">
                <video controls className="video" poster={pic2}>
            ...
            <section className="aboutus">
                <img src={pic6} alt="pic6" className="aboutus-img-full"/>
            </section>
            <section className="aboutus">
                <img src={pic7} alt="pic7" className="aboutus-img-full"/>
            </section>
            <section className="aboutus">
                <img src={pic8} alt="pic8" className="aboutus-img-full"/>
            </section>
            <section>
