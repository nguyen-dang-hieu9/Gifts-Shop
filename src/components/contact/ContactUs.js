    ...
    return (
        <div className="contact">
            ...
            <div className="contact-wrapper">
                <br />
                <p>
                    For all enquiries please use the below form to contact your
                    closest store who will get in contact shortly. Your closest
                    store is your service point and can assist you on claims,
                    product information, availability, delivery, prices, and
                    more. If you are enquiring about an order, please choose the
                    store where you made the purchase. If you are unsure which
                    store that is, or if that store has closed, then please
                    choose your closest store.
                </p>
                    ...
                    <div className="contact-wrapper-content">
                        <div className="contact-wrapper-content-address">
                            ...
                            <p>
                                ...
                                590 D. Cach Mang Thang 8, Ward 11, District 3,
                                Ho Chi Minh City
                            </p>
                            <p>
